...
processLineItemsRequest prods reqItems = traverse (processLineItemRequest prods) reqItems
...
inDiscountList (LineItem (Product _ _ prodId) _) discIds = elem prodId discIds
